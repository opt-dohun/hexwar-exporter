...
### 1. 매트릭 수집 및 변환 중계기 아키텍쳐 구축

#### 문제
* 폴링 대상인 게임 서버가 수평적으로 확장되어 100, 1000개로 늘어날 때, 고루틴을 무한정 생성한다면 많은 서버들을 대상으로 병렬 처리할 수 있지만 작업량이 많아져 그린 쓰레드 특유의 컨텍스트 비용 절감 효과가 줄어들고 메모리 사용량이 증가하여 고갈될 수 있는 문제를 확인하였습니다.
